...
//payment stripe
Route::get('/stripe', 'Payment\StripeController@stripe');
Route::post('/stripe-payment', ['uses' => 'Payment\StripeController@payStripe', 'as' => 'stripePayment']);
// Route::get('/stripe-payment-success', ['use' => 'Payment\StripeController@stripe', 'as' => 'stripePaymentSuccess']);
Route::get('/stripe-payment-error', ['uses' => 'Payment\StripeController@stripeError', 'as' => 'stripePaymentError']);
