    ...
    <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td><a href="{{ route('adminDeleteOrder',['id' => $order->order_id ])}}" class="btn btn-danger delete-warning">Remove</a></td>
...
function getPaymentInfo(order_id,status){
    if(status === 'paid'){
        ...
        $.get( "http://dev.shopmediolanum.com/payment/getPaymentInfoByOrderId/"+order_id, function( data ) {
