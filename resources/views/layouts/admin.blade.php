    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="{{ (request()->is('admin/createProductForm')) ? 'active' : '' }}"><a href="/admin/createProductForm">Add New Product</a></li>
                <li class="{{ (request()->is('admin/products')) ? 'active' : '' }}"><a href="{{route('adminDisplayProducts')}}">View Products<span class="sr-only">(current)</span></a></li>
                <hr>
                <div class="h2_like" style="">CATEGORIES</div>
                <div class="h3_like" style="">Women</div>
                <li class="{{ (request()->is('admin/add-women-category')) ? 'active' : '' }}"><a href="/admin/add-women-category">Add New Women Category</a></li>
                <li class="{{ (request()->is('admin/view-women-categories')) ? 'active' : '' }}"><a href="/admin/view-women-categories">View Women Categories</a></li>
